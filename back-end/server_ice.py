...
if 'ServerPrx' not in _M_ApplicationArchitecturesDistribuees.__dict__:
    ...
    class ServerPrx(Ice.ObjectPrx):
        ...
        def stopMusic(self, context=None):
            return _M_ApplicationArchitecturesDistribuees.Server._op_stopMusic.invoke(self, ((), context))

        def stopMusicAsync(self, context=None):
            return _M_ApplicationArchitecturesDistribuees.Server._op_stopMusic.invokeAsync(self, ((), context))

        def begin_stopMusic(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_ApplicationArchitecturesDistribuees.Server._op_stopMusic.begin(self, ((), _response, _ex, _sent, context))

        def end_stopMusic(self, _r):
            return _M_ApplicationArchitecturesDistribuees.Server._op_stopMusic.end(self, _r)

        def pauseMusic(self, context=None):
            return _M_ApplicationArchitecturesDistribuees.Server._op_pauseMusic.invoke(self, ((), context))

        def pauseMusicAsync(self, context=None):
            return _M_ApplicationArchitecturesDistribuees.Server._op_pauseMusic.invokeAsync(self, ((), context))

        def begin_pauseMusic(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_ApplicationArchitecturesDistribuees.Server._op_pauseMusic.begin(self, ((), _response, _ex, _sent, context))
