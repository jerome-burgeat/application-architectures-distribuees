...
public interface ServerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default boolean pauseMusic()
    {
        return pauseMusic(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean pauseMusic(java.util.Map<String, String> context)
    {
        return _iceI_pauseMusicAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> pauseMusicAsync()
    {
        return _iceI_pauseMusicAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> pauseMusicAsync(java.util.Map<String, String> context)
    {
        return _iceI_pauseMusicAsync(context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_pauseMusicAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "pauseMusic", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
